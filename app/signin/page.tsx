...
import { Key, Home, ArrowRight, CheckCircle, AlertCircle, Loader2, Sparkles, Copy, RefreshCw, Smartphone } from 'lucide-react'
import { PrimaryButton, GhostButton } from '@/components/Buttons'
import { requestOtpCode } from '@/lib/supabase/auth'
...
function SignInPageContent() {
  ...
  useEffect(() => {
    ...
    if (emailParam) {
      ...
      // Auto-request code if requested
